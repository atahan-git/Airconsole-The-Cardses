...
public class FrostEffect : MonoBehaviour
{
    ...
    public float EdgeSharpness = 2.33f; //>=1
    public float minFrost = 0; //0-1
    public float maxFrost = 0.36f; //0-1
    public float seethroughness = -0.82f; //blends between 2 ways of applying the frost effect: 0=normal blend mode, 1="overlay" blend mode
    public float distortion = 0.38f; //how much the original image is distorted through the frost (value depends on normal map)
